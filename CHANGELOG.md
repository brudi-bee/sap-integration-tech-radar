...
- Externe KI-Research-Runde konsolidiert und in Radar überführt (u. a. Edge Integration Cell, Kyma Runtime, Side-by-side extensibility, Circuit breaker, GraphQL/gRPC, RFC/BAPI HOLD)
- Zweite KI-Research-Runde verarbeitet (u. a. CPI Transport Management, Postman/Bruno, Choreography-Pattern, AMQP/MQTT) und Ring-Korrektur für Terraform auf TRIAL
- Dritte KI-Research-Runde verarbeitet: AEM und OpenTelemetry auf TRIAL angehoben, HOLD-Entries für File-drop-Integrationen und neue SOAP/WSDL-Interfaces ergänzt
- Vierte KI-Research-Runde verarbeitet: Build Process Automation auf ASSESS, Monitoring/Alerting + CTMS/Content Agent + ISA-M auf ADOPT, CTS+ als Übergang auf ASSESS, API-led connectivity ergänzt
- Fünfte KI-Research-Runde verarbeitet: Strangler auf ADOPT, CloudEvents-Envelope + Contract-first-Patterns ergänzt, AMQP auf ADOPT angehoben, MQTT + SFTP als ASSESS separat geführt
